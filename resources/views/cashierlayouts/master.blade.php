    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ (request()->is('cashier/dashboard')) ? 'active' : '' }}">
                <a class="nav-link" href="{{route('cdashboard')}}">
            ...
            <li class="nav-item {{ (request()->is('cashier/reports')) ? 'active' : '' }}">
                <a  class="nav-link" href="{{route('creports')}}">
                <i  class="fa fa-clipboard" aria-hidden="true"></i>
                    <span>Create New Report</span></a>
            </li>

            <li class="nav-item {{ (request()->is('cashier/pending')) ? 'active' : '' }}">
                <a  class="nav-link" href="{{route('cpending')}}">
                <i  class="fa fa-clipboard" aria-hidden="true"></i>
                    <span>Pending Report</span></a>
            </li>

            <li class="nav-item {{ (request()->is('cashier/issued')) ? 'active' : '' }}">
                <a  class="nav-link" href="{{route('cissued')}}">
                <i  class="fa fa-clipboard" aria-hidden="true"></i>
                    <span>Issued Report</span></a>
            </li>

            
            <!-- <li class="nav-item {{ (request()->is('cashier/testsetup')) ? 'active' : '' }}">
                <a  class="nav-link" href="{{route('testsetup')}}">
                <i class="fa fa-flask" aria-hidden="true"></i>
                    <span>Test Setup</span></a>
            </li>

            <li class="nav-item {{ (request()->is('cashier/testparameter')) ? 'active' : '' }}">
                <a  class="nav-link" href="{{route('testparameter')}}">
                <i class="fa fa-flask" aria-hidden="true"></i>
                    <span>Test Parameter</span></a>
            </li> -->

            <li class="nav-item {{ (request()->is('cashier/doctors')) ? 'active' : '' }}">
                <a  class="nav-link" href="{{route('cdoctors')}}">
                    <i class="fa fa-user-md" aria-hidden="true"></i>
                    <span>Lab Doctors</span></a>
            </li>

            <!-- <li class="nav-item {{ (request()->is('cashier/branches')) ? 'active' : '' }}">
                <a class="nav-link" href="{{route('branches')}}">
                <i class="fa fa-university" aria-hidden="true"></i>
                    <span>Lab Branches</span></a>
            </li>
            <li class="nav-item {{ (request()->is('cashier/users')) ? 'active' : '' }}">
                <a class="nav-link" href="{{route('users')}}">
                <i class="fa fa-user" aria-hidden="true"></i>
                    <span>Users</span></a>
            </li> -->

            <li class="nav-item {{ (request()->is('cashier/dated')) ? 'active' : '' }}">
                <a  class="nav-link" href="{{route('cdated')}}">
                <i  class="fa fa-clipboard" aria-hidden="true"></i>
