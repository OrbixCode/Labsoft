...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="{{asset('website/assets/img/labsoftlogo.png')}}" rel="icon">
        <link href="{{asset('website/assets/img/labsoftlogo.png')}}" rel="icon">
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html"><img src="{{asset('website/assets/img/labsoftlogo.png')}}" alt="" class="img-fluid"></a></h1>
      ...
      <!-- <a href="tel:+1 5589 55488 55" class="appointment-btn scrollto"><span class="d-none d-md-inline">Call Us</span>+1 5589 55488 55</a> -->
      @if (Route::has('login'))
                <div class="top-right links">
                    @auth
                        <a href="{{ url('/') }}">Home</a>
                    @else
                    <a href="{{ route('login') }}" class="appointment-btn scrollto"><span class="d-none d-md-inline">Login</span> Account</a>
                        <!-- <a href="{{ route('login') }}">Login</a> -->
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <h1>Welcome to Labsoft</h1>
      <h2>We are concerns the analysis of blood, urine and tissue samples to examine and diagnose disease</h2>
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{asset('website/assets/img/gallery/gallery-1.jpg')}}" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{asset('website/assets/img/gallery/gallery-2.jpg')}}" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{asset('website/assets/img/gallery/gallery-3.jpg')}}" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{asset('website/assets/img/gallery/gallery-4.jpg')}}" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{asset('website/assets/img/gallery/gallery-5.jpg')}}" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{asset('website/assets/img/gallery/gallery-6.jpg')}}" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{asset('website/assets/img/gallery/gallery-7.jpg')}}" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{asset('website/assets/img/gallery/gallery-8.jpg')}}" class="galelry-lightbox">
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>Labsoft</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          ...
          Designed by <a href="https://orbixcode.com/">OrbixCode</a>
        </div>
      </div>
