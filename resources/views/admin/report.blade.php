  ...
  <div class="modal-dialog  modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form id="addreportform" action="{{route('add.report')}}" method="post" enctype="multipart/form-data">
          @csrf
...
<div class="modal fade" id="editreportmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog  modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form id="editreportform" action="{{route('update.report.details')}}" method="post" enctype="multipart/form-data">
          @csrf
...
<script>
        ...
        $.ajax({
        url:"{{ route('get.testpara-dropdown') }}",
        type: "POST",
        data: {
...
$.ajaxSetup({
    ...
    /// END GET test IN POPUP
        ...
        var report_id=$(this).data('id');
        $.post('<?= route('get.test.view') ?>',{report_id:report_id},function(data){
