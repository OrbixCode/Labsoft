...
<div class="modal fade" id="editdoctormodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog  modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form id="editDoctorform" action="{{route('update.doctor.details')}}" method="post" enctype="multipart/form-data">
          @csrf
...
$.ajaxSetup({
    ...
    $(document).on('click',"#EditDoctor",function(){
        ...
        $.post('<?= route('get.doctor.details') ?>',{doctor_id:doctor_id},function(data){
        ...
        // swal.fire({
        //     title:'Are You Sure',
        //     html:'You Want To <b>Delete</b> This Doctor',
